...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const url = `https://admin.5l3t-mjbm.click/register_gb/${formData.title}`;
  ...
  return (
    <div>
      ...
      <form className="admin-form" onSubmit={handleSubmit}>
        ...
        <div>
          제목:
          <input className="admin-form" type="text" name="title" placeholder="Title" onChange={handleChange} />
        </div>
        <div>
          장르:
